...
### Solver Configuration for Extreme Conditions
...
5. The default solver step limit (`maxSteps: 2000`) is insufficient under extreme evaporation conditions; increasing it to 20 000 resolves convergence at all tested parameter combinations without computational penalty.
