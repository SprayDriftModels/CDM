...
if (measurements==1){
  ...
  z1<-6.6
  z2<-1.66667
  ux1<-12.8 ## original default is 13.5
  ux2<-9.44
}
...
hcm<-0.254 # Canopy height in cms (Droplet Transport Calculations)
...
# ________________________________________
# User Inputs:
IAR<-0.60880 #Intended Application Rate for Dicamba, lb/acre
...
MMM<-500 # Original value ? ## Number of droplet size bins
