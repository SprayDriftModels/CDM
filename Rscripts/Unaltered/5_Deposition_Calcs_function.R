#5_Deposition_Calcs
deposition_calcs<-function(IAR,xactive,FD,PL, NozzsleSpacing, psipsipsi,rhoL, Cent_inp,Dwnd_inp,Uwnd_inp, Dpmax, DDpmin, a, MMM, lambda){
...
#  a<-c(380.638,863.849,128.461,244.358,0.178) # Monsanto provided Calibration
#  a<-c(515.6306540,962.9808819,197.3155487,206.8327430,0.4204937) # Exponent calibration; should be provided as function input; for debugging for now
  ...
  return(list(XX=XX,APplume=APplume))
