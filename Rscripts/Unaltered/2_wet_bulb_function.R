...
#  rm(list = ls())
  ...
  # Tdp calculates correct result; AV 11192019
  
  yw<-RH*Psw(Tdp)/100/Patm
  # yw calculates correct result; AV 11192019
  
  omega<-yw*MWw/(1-yw)/MWair
  # omega calculates correct result; AV 11192019
