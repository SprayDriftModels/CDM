...
struct Model
{
    ...
    std::vector<std::pair<double, double>> wvu;             // [INPUT] Elevation and velocity [m, m/s]
    std::vector<std::pair<double, double>> wvT;             // [INPUT] Elevation and temperature [m, °C]
    ...
    double pppcalc;                                         // [DERIVED] Horizontal variation in wind direction around mean (ψψψ) [degrees]
